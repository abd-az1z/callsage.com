...
const pricingCardSecondayTextVariants = cva("text-neutral-700", {
  variants: {
    variant: {
    ...
    <div className={cn(pricingCardVariants({ variant }), className, "border")}>
      <div className="flex items-end gap-x-4 justify-between">
        <div className="flex flex-col gap-y-2">
          ...
          <p className={cn(pricingCardSecondayTextVariants({ variant }))}>
            {description}
          </p>
        </div>
        <div className="flex items-end shrink-0 gap-x-0.5 ">
          ...
          <span className={cn(pricingCardSecondayTextVariants({ variant }))}>
            {priceSuffix}
          </span>
        </div>
      </div>
      ...
      <div className="flex-col gap-y-2 mt-6">
        <p className="font-medium uppercase">Features</p>
          <ul
            className={cn(
              "flex flex-col gap-y-2.5",
              pricingCardSecondayTextVariants({ variant })
            )}
          >
